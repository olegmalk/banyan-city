...
def main() -> int:
    ...
    lines = [
        ...
        "#",
        "# WHAT v2 BOUGHT, 2026-08-21. The LIGHTING axis. v1 was 26 frames over",
        "# eleven plates and every one of those plates was DAYLIT -- flat",
        "# daylight, sunset backlight, dawn mist, heavy overcast, alpine midday,",
        "# forest dapple, even daylight, pale dawn, strong backlight, hard midday",
        "# sun, bright daylight -- so the trigger was being taught a time of day,",
        "# the same defect as a shared backdrop one axis over. Round 5 rendered",
        "# fourteen non-daylit plates, four survived the bar (night, storm shaft,",
        "# rain, after-rain) and eleven more frames were composited onto them.",
        ...
        "# out of the trigger -- but its VALUE is still constant. Covering the",
        "# 004-and-later crown needs a tool that can draw three, five and six",
        "# leaves. That tool does not exist and is not written here, so this",
        "# remains the set's named cap rather than a thing v2 quietly fixed.",
        "#",

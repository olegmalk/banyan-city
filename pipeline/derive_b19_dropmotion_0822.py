...
SPEC_ID = "ep2-b19-dropmotion-0822"
...
NEW_SRC = ("C:\\banyan-farm\\courier-box\\farm-out\\ep2-b19-sapgloss-0819"
           "\\b19-sapgloss-s20260819.png")
NEW_SHA = "5a62ff900df2e22c45df8d5b8c0a22c85f374a53cd7fa9b64483e7716d77c11c"
...
def build():
    child = derive_spec.derive(
        ...
        by="pipeline/derive_b19_dropmotion_0822.py",
    )
...
def _selftest():
    ...
    assert NEW_SRC in argv and NEW_SHA in argv, "the init is not the sapgloss plate"
    assert OLD_SRC not in argv and OLD_SHA not in argv, "the w4 plate survived"
    assert "sapgloss" in NEW_SRC

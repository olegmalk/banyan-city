...
PARENT = "pipeline/jobs/ep2-b13-lowerbody-oneknee-0822.yaml"
NEW_ID = "ep2-b13-lowerbody-oneknee-r2-0822"
OLD_SEED = 20260823
NEW_SEED = 20260824
...
def main() -> int:
    ...
    child = derive_spec.derive(
        PARENT, NEW_ID,
        fresh={
            "owner": "the goblin v3 lane, 2026-08-22 -- the one-knee reseed",
            "consumer": (
                "THE v3 DATASET, conditionally. Round one's one-knee is the "
            ...
            "success": (
                "ONE 832x1216 png whose right thigh reads within 40 RGB units "
            ...
            "why": (
                "THE BEST GEOMETRY IN THE SET IS ALSO ITS WORST PAINT, and only "
        ...
        retoken=[("b13lowerbodyoneknee-0822", "b13lowerbodyonekneer2-0822"),
                 ("b13-lowerbody-oneknee-s%d" % OLD_SEED,
                  "b13-lowerbody-oneknee-r2-s%d" % NEW_SEED),
                 ("b13-lowerbody-oneknee-DRY", "b13-lowerbody-oneknee-r2-DRY")],
        by="pipeline/derive_jerry_lowerbody_oneknee_r2_0822.py",
    )

    ...
    12: dict(
        ...
        candidates=[
            dict(file=f"{CAND_URL}/12-related-LTX-leaf-0813.mp4",
                 ...
                 label="THIS BEAT'S FIRST CANDIDATE — canon's two leaves, and the plant STOPS GROWING", tag="warn",
            ...
            dict(file=f"{CAND_URL}/12-related-LTX-nogrowclean-0822.mp4",
                 poster=f"{POSTER_URL}/12-related-LTX-nogrowclean-0822.jpg",
                 label="and telling it not to grow, on the clean sky, does nothing \u2014 08-22", tag="fail",
                 verdict="122 px of climb, against 108 px for the same clip without the sentence. So the instruction is not merely weak here, it is absent: the plant grows the same amount whether or not the prompt says \u2018the stem does not lengthen and the two leaf tips are at the same height in the last frame as in the first\u2019. The sky is clean, the count holds at two, everything else is fine. THE CANDIDATE AT THE TOP STAYS THE LEAD.",
                 diff="This sentence was tried once before and read as \u2018no harm, no help\u2019 \u2014 but that test ran on the plate that was already holding still, so the sentence had nothing to resist. This is the same sentence on the plate that grows, which is the only place it could ever have shown an effect. It shows none. WHAT THAT LEAVES: beat 12 is now a straight choice between a sky with a soft band across it and a plant that stands still, or a clean sky and a plant that climbs. Two seeds on the clean plate are on the card to say whether the climb is the plate or the draw.",
                 src="pipeline/jobs/ep2-b12-nogrow-clean-0822.yaml"),
            dict(file=f"{CAND_URL}/12-related-LTX-cleanseed-s1-0822.mp4",
                 poster=f"{POSTER_URL}/12-related-LTX-cleanseed-s1-0822.jpg",
                 label="the clean sky on a second draw \u2014 grows the same, and the leaves go back to DISCS", tag="fail",
                 verdict="122 px of climb, the same as the two clips above it, so the growth is not one unlucky draw. And it costs the thing this beat spent a week buying: by the end the two leaves are big round discs with veins drawn on them \u2014 the exact shape your 08-17 ruling replaced.",
                 diff="One variable: the random seed, 20260813 \u2192 20260901. Same clean plate, same words, same everything.",
                 src="pipeline/jobs/ep2-b12-cleanseed-s1-0822.yaml"),
            dict(file=f"{CAND_URL}/12-related-LTX-cleanseed-s2-0822.mp4",
                 poster=f"{POSTER_URL}/12-related-LTX-cleanseed-s2-0822.jpg",
                 label="a third draw on the clean sky \u2014 it fails differently, which is the answer", tag="fail",
                 verdict="This one does not grow. The two leaves FOLD SHUT instead, closing into a single bud shape halfway through and reopening lower than they started. So the clean plate does not have one fault, it has no settled behaviour \u2014 three draws, three different things, none of them still.",
                 diff="One variable: the seed, 20260902. THE WHOLE POINT OF THESE TWO: the still clip at the top of this beat has a soft band across its sky, and every version with the band removed moves the plant. Three draws say that is the plate and not luck. THE READING, and it is uncomfortable: THE STILLNESS WAS A SIDE EFFECT OF THE DEFECT \u2014 the band is a hard static shape in the sky and the model appears to hold onto it. So beat 12 is a real choice, not a bug waiting to be fixed: a soft band and a plant that stands still, or a clean sky and a plant that does something. The lead stays the still one, and the next thing worth trying costs no GPU at all \u2014 shortening the clip.",
                 src="pipeline/jobs/ep2-b12-cleanseed-s2-0822.yaml"),
